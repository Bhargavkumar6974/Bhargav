...
//	public void setNo_of_student(int no_of_student) {
	...
	public HostelEntity(int hostel_id, String hostel_name, String hostel_admin, int no_of_floors, int no_of_wardens) {
		super();
		this.hostel_id = hostel_id;
		this.hostel_name = hostel_name;
		this.hostel_admin = hostel_admin;
	...
	public String toString() {
		return "HostelEntity [hostel_id=" + hostel_id + ", hostel_name=" + hostel_name + ", hostel_admin="
				+ hostel_admin + ", no_of_floors=" + no_of_floors + ", no_of_wardens=" + no_of_wardens + "]";
	}
